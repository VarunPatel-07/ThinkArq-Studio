...
function Notification() {
  ...
  const { notificationInfoArray } = useContext(NotificationContext) as NotificationContextApiProps;
              ...
              .map((notification: NotificationObject) => {
                ...
                return (
                  <div
                    key={notification.id}
                    id={notification.id}
                    className={`bg-(--theme-black-color) shadow-[0px_0px_10px_0px_rgba(0,0,0,0.3)] rounded-md pl-3 pr-5 py-2 ${
