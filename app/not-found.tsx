...
export const metadata: Metadata = {
  title: "404 — Page Not Found | Think Arq",
  description:
    "The page you're looking for doesn't exist. Explore Think Arq's AI development, custom software, and digital marketing services.",
  robots: {
    index: false,
    follow: false,
  },
